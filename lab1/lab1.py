...
grandchild_rule = IF(AND('parent (?x) (?y)',
                          'parent (?y) (?z)'),
                      THEN('grandchild (?z) (?x)'))
...
# family_rules.
family_rules = [identity_rule, siblings_rule, brother_rule, sister_rule, father_rule,
                mother_rule, son_rule, daughter_rule, cousin_rule, grandparent_rule, grandchild_rule]                    # fill me in
...
HOW_MANY_HOURS_THIS_PSET_TOOK = '6hr.. jk this is taking longer than expected'
WHAT_I_FOUND_INTERESTING = 'I like this idea of chaining, it is cute.'
WHAT_I_FOUND_BORING = 'Reading and syntax SO frustrating'
