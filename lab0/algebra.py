...
def do_multiply(expr1, expr2):
    ...
    * expr1 is a Sum, and expr2 is a Sum (a + b) (c + d) = ac + ad + bc + bd
    * expr1 is a Sum, and expr2 is a Product
    * expr1 is a Product, and expr2 is a Sum (a * b) (c + d) = abc + abd
    * expr1 is a Product, and expr2 is a Product (a * b) *(c * d)= abcd
    ...
    if isinstance (expr1, Sum) and isinstance (expr2, Sum):
        ...
        for term1 in expr1:
            for term2 in expr2:
                sumTerms.append(Product([term1, term2]))
    ...
    if isinstance (expr1, Sum) and isinstance (expr2, Product):
        ...
        for term1 in expr1:
            newTerms = []
            newTerms.append(term1)
            for term2 in expr2:
                newTerms.append(term2)
            sumTerms.append(Product(newTerms))
